...
`sbox` is reflected below (generated with [print_table.py](https://github.com/thondascully/cryptography/blob/master/digraph-substitution-cipher/python/print_table.py))
